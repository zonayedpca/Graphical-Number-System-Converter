...
converter.prototype.numCon = function() {
	...
	document.querySelector('.inNum').textContent = this.num;
	...
	while(this.num > 1) {
		...
		if(rem > 9) {
			...
			document.querySelector('.stndrd-result').innerHTML += '<span class = "stdresult">' + hexCon + '</span>';
		} else {
			getDom.normalResult.innerHTML += '<li class="normalRem">'+ rem + '</li><br>';
			document.querySelector('.stndrd-result').innerHTML += '<span class = "stdresult">' + rem + '</span>';	
		} 
	}

	document.querySelector('.stndrd-result').innerHTML += '<span class = "stdresult">' + this.num + '</span>';
...
var calculator = function(event) {
	...
	document.querySelector('.stndrd-result').innerHTML = '';
